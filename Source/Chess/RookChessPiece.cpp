...
{
    return Super::GetValue() * 500 + (bIsWhite ? RookPieceSquareTable[CurrentPosition.X][CurrentPosition.Y] : -RookPieceSquareTable[UKismetMathLibrary::Abs_Int(7 -CurrentPosition.X)][UKismetMathLibrary::Abs_Int(7 -CurrentPosition.Y)]);
}

TArray<FIntPoint> ARookChessPiece::GetPossibleMovePositionsForEnemy()
{
    TArray<FIntPoint> PossibleMoves;
    if(ChessBoard)
    {
